...
export default function Login() {
    ...
    return <div className="container flex h-full items-center justify-center">
        <form className="bg-gray-50 flex justify-center items-center flex-col p-5 shadow-xl rounded-xl w-1/3 h-fit border-gray-200">
            <div className="mb5 w-full flex flex-col">
                ...
                <input className="bg-blue-50 w-full h-10 border rounded border-gray-200 pl-2" 
                       value={email} onChange={(e) => setEmail(e.target.value)} type="text" placeholder="pavlik@gmail.com"/>
            </div>
