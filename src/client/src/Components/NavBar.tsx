    ...
    <div
      className={
        location.pathname == "/login" || location.pathname == "/register"
          ? "hidden"
          : "w-full bg-[#0070BB] p-3 flex justify-between shadow items-center flex-1"
      }
    >
      <div onClick={navigateHome} className="cursor-pointer">
        <img
          className="w-64"
          src="/Logo/SVG/Think-different-Academy_LOGO_oficialni-bile.svg"
      ...
      <div className="">
        {isAuthenticated ? (
          ...
          <button
            className="p-3 bg-[#49B3B4] rounded"
